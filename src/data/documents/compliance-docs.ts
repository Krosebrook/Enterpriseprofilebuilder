...
export const complianceDocs: DocumentResource[] = [
  ...
  {
    id: 'audit-findings-summary',
    title: 'Audit Findings Summary',
    description: 'Summary of audit findings and recommendations for Claude enterprise deployment.',
    category: 'compliance',
    fileName: 'AUDIT_FINDINGS_SUMMARY.md',
    downloadPath: '/docs/compliance/AUDIT_FINDINGS_SUMMARY.md',
    section: 'governance',
    tags: ['audit', 'findings', 'summary', 'compliance', 'recommendations'],
    lastUpdated: '2025-12-17',
    order: 2,
  },
  {
    id: 'epb-phases-7-11-audit',
    title: 'EPB Phases 7-11 Comprehensive Audit',
    description: 'Comprehensive audit document covering phases 7-11 of the Enterprise Profile Builder project.',
    category: 'compliance',
    fileName: 'EPB_PHASES_7_11_COMPREHENSIVE_AUDIT.md',
    downloadPath: '/docs/compliance/EPB_PHASES_7_11_COMPREHENSIVE_AUDIT.md',
    section: 'governance',
    tags: ['audit', 'phases', 'comprehensive', 'EPB', 'review'],
    lastUpdated: '2025-12-17',
    order: 3,
    featured: true,
  },
  {
    id: 'audit-deep-dive-report',
    title: 'Audit Deep Dive Report',
    description: 'In-depth audit analysis report with detailed findings and actionable recommendations.',
    category: 'compliance',
    fileName: 'Audit_Deep_Dive_Report.md',
    downloadPath: '/docs/compliance/Audit_Deep_Dive_Report.md',
    section: 'governance',
    tags: ['audit', 'deep-dive', 'analysis', 'detailed', 'report'],
    lastUpdated: '2025-12-17',
    order: 4,
  },
];
