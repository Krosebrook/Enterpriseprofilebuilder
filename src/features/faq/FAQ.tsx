...
export function FAQ({ searchQuery = '' }: FAQProps) {
  ...
  const levelColors = {
    ...
    intermediate: { bg: 'bg-blue-50', border: 'border-blue-200', badge: 'secondary' as const }, // Use valid badge variant
    advanced: { bg: 'bg-purple-50', border: 'border-purple-200', badge: 'destructive' as const } // Use valid badge variant
  };
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="space-y-4">
        {filteredFaqs.map((faq) => {
          ...
          const colors = levelColors[faq.level] || levelColors.beginner;
            ...
            >
              ...
              >
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  <Badge variant={colors.badge} className="flex-shrink-0">
                    {faq.level}
                  </Badge>
